...
def get_run_defaults(config: Dict[str, Any] | None = None) -> Dict[str, Any]:
    ...
    return {
        ...
        "lag_best_lag_tie_eps": float(lag_cfg.get("best_lag_tie_eps", 1e-6)),
        ...
        "lag_l0_max_lag": lag_cfg.get("l0_max_lag", None),
        "lag_l0_min_support": lag_cfg.get("l0_min_support", None),
        "lag_l0_include_best_lag": lag_cfg.get("l0_include_best_lag", False),
        "lag_l0_tie_eps": float(lag_cfg.get("l0_tie_eps", 1e-6)),
