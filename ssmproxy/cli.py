...
def build_run_config(
    ...
    return RunConfig(
        ...
        lag_best_lag_mode=defaults["lag_best_lag_mode"],
        lag_best_lag_lcb_z=defaults["lag_best_lag_lcb_z"],
        lag_best_lag_tie_eps=defaults["lag_best_lag_tie_eps"],
        lag_min_support_ratio=defaults["lag_min_support_ratio"],
        lag_l0_tau=defaults["lag_l0_tau"],
        lag_l0_min_hits=defaults["lag_l0_min_hits"],
        lag_l0_max_lag=defaults["lag_l0_max_lag"],
        lag_l0_min_support=defaults["lag_l0_min_support"],
        lag_l0_include_best_lag=defaults["lag_l0_include_best_lag"],
        lag_l0_tie_eps=defaults["lag_l0_tie_eps"],
